...
namespace RA8876const
{
	...
	enum BTE_CTRL1_Bits
	{
		...
		BTE_CTRL1_RopNotS0andNotS1 = 0x10,
		BTE_CTRL1_RopNotS0andS1 = 0x20,
		BTE_CTRL1_RopNotS0 = 0x30,
		BTE_CTRL1_RopS0andNotS1 = 0x40,
		BTE_CTRL1_RopNotS1 = 0x50,
		BTE_CTRL1_RopS0xorS1 = 0x60,
		BTE_CTRL1_RopNotS0orNotS1 = 0x70,
		BTE_CTRL1_RopS0andS1 = 0x80,
		BTE_CTRL1_RopNotS0xorS1 = 0x90,
		BTE_CTRL1_RopS1 = 0xA0,
		BTE_CTRL1_RopNotS0orS1 = 0xB0,
		BTE_CTRL1_RopS0 = 0xC0,
		BTE_CTRL1_RopS0orNotS1  = 0xD0,
		BTE_CTRL1_RopS0orS1 = 0xE0,
		BTE_CTRL1_RopWhite = 0xF0,
