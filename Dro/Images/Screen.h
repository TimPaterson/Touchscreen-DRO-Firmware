...
START_HOTSPOTS(LatheMain)
	...
	DEFINE_HOTSPOT(DiameterRadius, , 10, 114, 69, 173)
	DEFINE_HOTSPOT(ToolSfm, ToolLib, 468, 102, 557, 165)
	DEFINE_HOTSPOT(CompoundEnable, , 90, 114, 149, 173)
	DEFINE_HOTSPOT(CompoundAngle, , 254, 123, 358, 164)
...
START_AREAS(LatheMain)
	...
	DEFINE_AREA(DiameterRadius, 10, 114, 60, 60)
	DEFINE_AREA(SpeedUnits, 379, 103, 89, 31)
	DEFINE_AREA(Sfm, 483, 104, 74, 28)
	DEFINE_AREA(Rpm, 483, 136, 74, 28)
	DEFINE_AREA(CompoundEnable, 90, 114, 60, 60)
	DEFINE_AREA(AngleDisplay, 150, 102, 218, 84)
	DEFINE_AREA(CompoundAngle, 254, 123, 113, 42)
END_AREAS(LatheMain)
...
HOTSPOT_COUNT(LatheSettingsScreen, 19)
...
START_GROUP()
	...
	GROUP_HOTSPOT(DiameterRadius, , 10, 114, 69, 173)
	GROUP_HOTSPOT(CompoundEnable, , 90, 114, 149, 173)
	GROUP_HOTSPOT(CompoundAngle, , 254, 123, 358, 164)
...
START_GROUP_()
	...
	GROUP_HOTSPOT_(DiameterRadius, , 10, 114, 69, 173)
	GROUP_HOTSPOT_(CompoundEnable, , 90, 114, 149, 173)
	GROUP_HOTSPOT_(CompoundAngle, , 254, 123, 358, 164)
