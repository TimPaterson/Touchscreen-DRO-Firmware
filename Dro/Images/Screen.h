...
START_AREAS(LatheMain)
	...
	DEFINE_AREA(CompoundAngleDisplay, 80, 70, 288, 118)
...
START_HOTSPOTS(CompoundAngleDisplay)
END_HOTSPOTS(CompoundAngleDisplay)

HOTSPOT_COUNT(CompoundAngleDisplay, 0)
...
START_SCREEN_Overlay(CompoundAngleDisplay)
	IMAGE_ADDRESS_Overlay(1456568)
	IMAGE_SIZE_Overlay(67968)
	IMAGE_WIDTH_Overlay(288)
	IMAGE_HEIGHT_Overlay(118)
	IMAGE_STRIDE_Overlay(288)
	IMAGE_DEPTH_Overlay(Color16bpp)
END_SCREEN_Overlay(CompoundAngleDisplay)

START_SCREEN_Overlay(Coord)
	IMAGE_ADDRESS_Overlay(1524536)
