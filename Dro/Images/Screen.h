...
START_HOTSPOTS(MainScreen)
	...
	DEFINE_HOTSPOT(ToolChipLoad, ToolLib, 480, 507, 569, 570)
...
START_HOTSPOTS(SpeedDisplay)
	...
	DEFINE_HOTSPOT(ToolChipLoad, ToolLib, 280, 32, 369, 95)
	DEFINE_HOTSPOT(ToolSfm, ToolLib, 461, 32, 550, 95)
	DEFINE_HOTSPOT(ToolChipLoad, ToolLib, 651, 32, 740, 95)
...
START_GROUP(ToolLib)
	...
	GROUP_HOTSPOT(ToolChipLoad, ToolLib, 480, 507, 569, 570)
	GROUP_HOTSPOT(ToolSfm, ToolLib, 90, 32, 179, 95)
	GROUP_HOTSPOT(ToolChipLoad, ToolLib, 280, 32, 369, 95)
	GROUP_HOTSPOT(ToolSfm, ToolLib, 461, 32, 550, 95)
	GROUP_HOTSPOT(ToolChipLoad, ToolLib, 651, 32, 740, 95)
...
START_GROUP_ToolLib(ToolLib)
	...
	GROUP_HOTSPOT_ToolLib(ToolChipLoad, ToolLib, 480, 507, 569, 570)
	GROUP_HOTSPOT_ToolLib(ToolSfm, ToolLib, 90, 32, 179, 95)
	GROUP_HOTSPOT_ToolLib(ToolChipLoad, ToolLib, 280, 32, 369, 95)
	GROUP_HOTSPOT_ToolLib(ToolSfm, ToolLib, 461, 32, 550, 95)
	GROUP_HOTSPOT_ToolLib(ToolChipLoad, ToolLib, 651, 32, 740, 95)
