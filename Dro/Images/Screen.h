...
START_HOTSPOTS(LatheMain)
	...
	DEFINE_HOTSPOT(DiameterRadius, , 10, 102, 69, 161)
	DEFINE_HOTSPOT(ToolSfm, ToolLib, 483, 102, 572, 165)
END_HOTSPOTS(LatheMain)

HOTSPOT_COUNT(LatheMain, 6)
...
START_AREAS(LatheMain)
	...
	DEFINE_AREA(DiameterRadius, 10, 102, 60, 60)
	DEFINE_AREA(SpeedUnits, 394, 103, 89, 31)
END_AREAS(LatheMain)
...
START_GROUP()
	...
	GROUP_HOTSPOT(DiameterRadius, , 10, 102, 69, 161)
...
START_GROUP(ToolLib)
	...
	GROUP_HOTSPOT(ToolSfm, ToolLib, 483, 102, 572, 165)
...
START_GROUP_()
	...
	GROUP_HOTSPOT_(DiameterRadius, , 10, 102, 69, 161)
...
START_GROUP_ToolLib(ToolLib)
	...
	GROUP_HOTSPOT_ToolLib(ToolSfm, ToolLib, 483, 102, 572, 165)
